...
//! 
//! this module is inspired by nom(https://github.com/Geal/nom)
use serde_derive::*;
use nom::error::ParseError;
use nom::IResult;
use nom::number::streaming::{le_u8, le_u16, le_u24, le_u64};
...
pub fn len_enc_int<'a, E>(input: &'a [u8]) -> IResult<&'a [u8], LenEncInt, E>
where
    E: ParseError<&'a [u8]>,
{
